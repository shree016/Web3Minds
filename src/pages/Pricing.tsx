...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Whitepaper library — Tier 1 only', included: true },
      { text: '5 RAG whitepaper questions/day', included: true },
      { text: '"From the Whitepaper" AI tab', included: false },
      { text: 'Comprehension depth scoring', included: false },
      { text: 'Full RAG-powered learning path', included: false },
      { text: 'Write mini-whitepaper (capstone)', included: false },
      { text: 'Save progress & portfolio', included: false },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Full RAG-powered learning path', included: true },
      { text: 'All whitepaper tiers unlocked', included: true },
      { text: 'Unlimited RAG whitepaper questions', included: true },
      { text: '"From the Whitepaper" AI tab', included: true },
      { text: 'Comprehension depth scoring', included: true },
      { text: 'Write mini-whitepaper (capstone)', included: true },
      { text: 'Portfolio on profile page', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Class whitepaper progress dashboard', included: true },
      { text: 'Quiz history + analytics', included: true },
      { text: 'Certificates for all students', included: true },
      { text: 'Priority support', included: true },
      { text: 'Custom learning path templates', included: true },
